...
class BatchCollator(object):
    ...
    def __call__(self, batch):
        ...
        if self.method in ("base", ):
            ...
            # To test resnet baseline on YOT dataset, use line below
            # images = to_image_list(transposed_batch[0][0]["cur"], self.size_divisible)
        elif self.method in ("rdn", "mega", "dafa", "diffusion", "fgfa", "dff"):
            ...
            for key in transposed_batch[0][0].keys():
                ...
                elif key not in ("ref", "ref_l", "ref_m", "ref_g"):
