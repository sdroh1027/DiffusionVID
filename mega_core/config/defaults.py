...
_C.INPUT.TRANSFORM = False

# Image ColorJitter
_C.INPUT.BRIGHTNESS = 0.166
_C.INPUT.CONTRAST = 0.5
...
_C.INPUT.RANROM_PAD_PROB_TRAIN = 0.5
_C.INPUT.RANROM_PAD_SIZE_TRAIN = 1.0
_C.INPUT.RANROM_CROP_PROB_TRAIN = 0.5
_C.INPUT.RANROM_CROP_MIN_SIZE_TRAIN = 0.3
_C.INPUT.RANROM_CROP_MAX_SIZE_TRAIN = 1.0
_C.INPUT.RANROM_CROP_MAX_RATIO_TRAIN = 2.

# diffusion batch inference support for dataloader
_C.INPUT.INFER_BATCH = 1
...
_C.MODEL.VID.ROI_BOX_HEAD.ATTENTION.STAGE = 2  # this will be overwritten by vid_R_101_C4_MEGA_1x.yaml
...
_C.MODEL.VID.MEGA.MIN_OFFSET = -12  #0#-12#-12
_C.MODEL.VID.MEGA.MAX_OFFSET = 12  #0#12#0
_C.MODEL.VID.MEGA.ALL_FRAME_INTERVAL = 25 #1#25#13
_C.MODEL.VID.MEGA.KEY_FRAME_LOCATION = 12 #0#12#12
_C.MODEL.VID.MEGA.SHUFFLED_CUR_TEST = False

_C.MODEL.VID.MEGA.LOCAL = CN()
_C.MODEL.VID.MEGA.LOCAL.ENABLE = True
_C.MODEL.VID.MEGA.LOCAL.PIXEL_ATTEND = False

_C.MODEL.VID.MEGA.MEMORY = CN()
_C.MODEL.VID.MEGA.MEMORY.ENABLE = False
...
_C.MODEL.VID.MEGA.GLOBAL.SIZE = 50  # INITIAL_GLOBAL_SAMPLING_IMAGES
_C.MODEL.VID.MEGA.GLOBAL.SHUFFLE = True
_C.MODEL.VID.MEGA.GLOBAL.STOP_UPDATE_AFTER_INIT_TEST = True
_C.MODEL.VID.MEGA.GLOBAL.BOX_ATTEND = True
_C.MODEL.VID.MEGA.GLOBAL.PIXEL_ATTEND = False
_C.MODEL.VID.MEGA.GLOBAL.PIXEL_STAGE = 0

_C.MODEL.VID.MEGA.REF_NUM_LOCAL = 2
_C.MODEL.VID.MEGA.REF_NUM_MEM = 3
_C.MODEL.VID.MEGA.REF_NUM_GLOBAL = 4

_C.MODEL.VID.MEGA.RATIO = 0.2

_C.MODEL.VID.MEGA.MHA = False
_C.MODEL.VID.MEGA.MEMORY_MANAGEMENT_METRIC = "distance"  # mamba, queue, distance
_C.MODEL.VID.MEGA.MEMORY_MANAGEMENT_TYPE = "greedy"  # once, twice, sequential, greedy, random
_C.MODEL.VID.MEGA.MEMORY_MANAGEMENT_SIZE_TEST = 750
_C.MODEL.VID.MEGA.MEMORY_MANAGEMENT_SIZE_TRAIN = 300
_C.MODEL.VID.MEGA.MEMORY_MANAGEMENT_SIZE_PIXEL_TRAIN = 3000
_C.MODEL.VID.MEGA.MEMORY_MANAGEMENT_SIZE_PIXEL_TEST = 1000
...
_C.SOLVER.LR_SCHEDULER_TYPE = "step"
...
_C.SOLVER.CLIP_GRADIENTS.CLIP_VALUE = 0
